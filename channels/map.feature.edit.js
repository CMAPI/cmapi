cmapi.channel["map.feature.edit"] = {
  ...
  notes: [
    ...
    "When the feature is placed into edit mode the Map SHALL issue map.message.progress messsage with the messageId (provided by the originating edit request (the edit request can be generated by the map itself,) with all the properties set to there current values. This SHALL indicate to client widgets that the edit operation has started.",
    "During an edit when a user modifies the feature, a map SHALL send a map.message.progress message each time the feature is manipulated during an edit. For instance, if a point of a line is moved to a new location, a map.message.progress message SHALL be sent.",
